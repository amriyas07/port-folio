...
import JavaCer from '../assets/certfied/Java.png';
import CCer from '../assets/certfied/C.png';
import PythonCer from '../assets/certfied/Python.png';
...
function Certification() {
  return (
    <div className="containers">
        ...
        <div className="box divs"><p>Power BI</p><a href="https://olympus.mygreatlearning.com/courses/30824/certificate" target="_blank"><img src={PowerBi} className="img" alt="This is My SQL Certificate"/></a></div>
